...
export default function Bio() {
  return (
    <section id="bio" className="sm:flex-[1_1_80svh] flex flex-col gap-4 items-center">
        ...
        >
          ...
          <div className="lg:columns-2 text-balance">
            ...
            <p>
              ...
              Relational DBMS and other more flexible NoSQL DBMS like <i>MongoDB</i>.
            </p>
            <p>
              Fortunately, I've had the opportunity to sharpen my expertise in <i>SQL</i> and{" "}
              <i>MongoDB</i> through roles involving <i>SQL</i> reporting and complex MongoDB
              queries for large scale apps.
            </p>
            <p>
              Anyhow, assuming my choice of this field of endeavor of which factors and tools seem
              the most volatile and various compared to others, I'm on a day to day schedule of
              perpetual learning, stacking more technologies and IT skills not limited by web
              development, with no consideration for unreasonable rest, until the D-day.
            </p>
          </div>
        </article>
      </div>
